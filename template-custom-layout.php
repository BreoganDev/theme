<?php
/**
 * Template Name: Diseño Personalizable
 * Description: Una plantilla que permite deshabilitar el header y/o footer.
 */
    ...
    <div class="container page-container">
        ...
        while (have_posts()) :
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('page-content'); ?>>
                <?php if (!is_front_page()) : // No mostrar el título si es la página de inicio ?>
